...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError("");
        setLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$holiday$2d$study$2d$buddy$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"])(loginEmail, loginPassword);
    ...
    const handleSignup = async (e)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$holiday$2d$study$2d$buddy$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUp"])(signupEmail, signupPassword, signupName);
        if (result.success && result.user) {
            setAuthState({
                user: result.user,
                isAuthenticated: true,
...
//# sourceMappingURL=Downloads_holiday-study-buddy_0e262809._.js.map