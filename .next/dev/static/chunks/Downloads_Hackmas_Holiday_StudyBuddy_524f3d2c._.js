...
"[project]/Downloads/Hackmas_Holiday_StudyBuddy/components/app-header.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function Home() {
   ...
   * ---------------------------------------------------------------------------------- */ const startSession = async ()=>{
        ...
        if (selectedTask && selectedTask !== 'none') {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hackmas_Holiday_StudyBuddy$2f$lib$2f$user$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startFocusSession"])(selectedTask);
    ...
    const endSession = async ()=>{
        ...
        if (sessionId) {
            ...
            ;
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hackmas_Holiday_StudyBuddy$2f$lib$2f$user$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["endFocusSession"])(sessionId, duration);
            if (res) {
                if (res.cheated) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hackmas_Holiday_StudyBuddy$2f$lib$2f$user$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveFocusSession"])(25, selectedTask);
            refreshStats();
        }
...
//# sourceMappingURL=Downloads_Hackmas_Holiday_StudyBuddy_524f3d2c._.js.map